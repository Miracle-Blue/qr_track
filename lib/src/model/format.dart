...
abstract class Format {
  ...
  static const int linearCodes =
      codabar | code39 | code93 | code128 | ean8 | ean13 | itf | dataBar | dataBarExpanded | upca | upce;
  static const int matrixCodes = aztec | dataMatrix | maxiCode | pdf417 | qrCode | microQRCode | rmqrCode;
